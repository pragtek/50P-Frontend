...
//       gqlMutate({
//         path: "/graphql",
//         inData: { gql: APPLY_JOB(Number(job), USER_ID) },
//       }),
//     onSuccess: (res) => {
...
//   // ---------------------------------------
//   return (
//     <Box maxWidth="1000px" mx="auto" p={5}>
//       <Button
...
//           <Chip icon={<PlaceIcon />} label={jobData.location} />
//           <Chip icon={<CurrencyRupeeIcon />} label={`Rs. ${jobData.salary}`} />
//           <Chip icon={<BusinessIcon />} label={`Experience: ${jobData.experience}`} />
//           <Chip icon={<CategoryIcon />} label={jobData.category} />
//         </Box>
...
//           Qualification
//         </Typography>
//         <Typography color="text.secondary">{jobData.qualification}</Typography>
...
//                 : "linear-gradient(135deg, #980d0dff, #b73636ff)",
//             }}
//           >
    ...
    <Box maxWidth="1000px" mx="auto" p={5}>
      ...
      <Paper elevation={6} sx={{ p: 4, borderRadius: 4 }}>
        ...
        <Box display="flex" flexWrap="wrap" gap={2} mb={3}>
          ...
          <Chip
            icon={<BusinessIcon />}
            label={`Experience: ${jobData.experience}`}
          />
          <Chip icon={<CategoryIcon />} label={jobData.category} />
        </Box>
